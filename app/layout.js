...
export const metadata = {
  ...
  title: {
    default: 'Raghav Sharma | Full-Stack Developer',
    template: '%s | Raghav Sharma',
  },
  description:
    'Computer Science student at Bennett University building full-stack web applications and AI-powered systems with React, TypeScript, Node.js, and Firebase.',
  keywords: [
    'Raghav Sharma',
  ...
  authors: [{ name: 'Raghav Sharma', url: SITE_URL }],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Raghav Sharma | Full-Stack Developer Portfolio',
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: [
                'https://github.com/Raghav-prog-max',
                'https://www.linkedin.com/in/raghav-sharma-948b32324',
              ],
            }),
          }}
        />
